...
//    private val itemApiResourceAdapter = ItemNamedApiResourceAdapter()
//
...
//            val pokemonDao = AppDatabase.getInstance(context).pokemonDao()
//            callback(
//                pokemonDao.getAllByIds((offset..limit).toList())
...
//            val pokemonDao = AppDatabase.getInstance(context).pokemonDao()
//
//            val pokemon = pokemonDao.getAllByIds(arrayListOf(id))
//            if (!pokemon.isEmpty()) {
